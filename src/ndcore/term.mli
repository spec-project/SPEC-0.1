...
val marshal_symbols : unit -> string
val unmarshal_symbols : string -> unit

val marshal_bind_stack : unit -> string
val unmarshal_bind_stack : string -> unit

val marshal_bind_len : unit -> string
val unmarshal_bind_len : string -> unit
